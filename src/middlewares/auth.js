 ...
 */
exports.verifyJWT = () => (req, res, next) => passport.authenticate('jwt', handleJWT(req, res, next))(req, res, next);


// Authentication middleware using OAuth
exports.oAuthLogin = (service, options={}) => passport.authenticate(service, options);
