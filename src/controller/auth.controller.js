 ...
 */
exports.forgotPasswordGET = (req, res, next) => res.render('forgot-password');
...
exports.forgotPasswordPOST = async (req, res, next) => {
	try {
		...
		console.log("Some error occured during forgot password POST, e = ", error.message);
		res.redirect('/v1/auth/password/forgot')
	}
}
